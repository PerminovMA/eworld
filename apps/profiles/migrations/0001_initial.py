    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(related_name='incoming_messages_set', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(related_name='outgoing_messages_set', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='city',
        ...
        migrations.AddField(
            ...
            name='cities',
            field=models.ManyToManyField(to='profiles.City'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
