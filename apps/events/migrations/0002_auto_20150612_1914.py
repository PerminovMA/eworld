...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='owner',
            field=models.ForeignKey(related_name='order_set', to='profiles.Client'),
        ),
        migrations.AddField(
            model_name='bet',
            name='auction',
            field=models.ForeignKey(to='events.AuctionOrder'),
        ),
        migrations.AddField(
            model_name='bet',
            name='owner',
            field=models.ForeignKey(to='profiles.EventManager'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='auctionorder',
            name='owner',
            field=models.ForeignKey(related_name='auctionorder_set', to='profiles.Client'),
        ),
    ]
